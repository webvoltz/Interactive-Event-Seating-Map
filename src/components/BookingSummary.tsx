        ...
        <div className="w-full md:w-[400px] h-auto md:h-full bg-white border-r border-gray-200 shadow-xl z-20 flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    <h3 className="text-xs font-bold text-gray-600 uppercase tracking-wider mb-3">Price Tiers</h3>
                    ...
                    <h3 className="text-xs font-bold text-gray-600 uppercase tracking-wider mb-3 mt-4 pt-3 border-t border-gray-200">Seat Status</h3>
                ...
                <div>
                    <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-4 flex justify-between items-center">
                        ...
                        {selectedSeats.size > 0 && (
                            <button onClick={clearSelection} className="cursor-pointer text-red-500 hover:text-red-600 hover:underline">Clear</button>
                        )}
                    </h3>
